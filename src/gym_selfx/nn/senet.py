"""
senet implementation in pytorch

by weiaicunzai <https://github.com/weiaicunzai>
from https://github.com/mountain/pytorch-cifar100/blob/master/models/senet.py
modified for special usage of selfx project
