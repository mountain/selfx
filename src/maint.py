...
train_envs = ts.env.ShmemVectorEnv([lambda: gym.make('selfx-billard-v0') for _ in range(64)])
test_envs = ts.env.ShmemVectorEnv([lambda: gym.make('selfx-billard-v0') for _ in range(128)])
